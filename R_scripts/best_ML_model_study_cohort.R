...
p2 = ComplexHeatmap::HeatmapAnnotation(Importance = anno_barplot(a_imp_ordered$Overall, gp = gpar(fill=ifelse(a_imp_ordered$`groups_imp$groups_imp`==0,"#073444","#bae9fa"))), height = unit(3, "cm"), HPF_Group=groups_for_pheatmap_genuses$Group,col=list(HPF_Group=c("Group 1"="#073444","Group 2"="#bae9fa")),annotation_name_gp = gpar(fontsize = 10, fontface = "bold"), annotation_legend_param = list(title="", labels_gp = gpar(font=2, fontsize = 12)), border = TRUE, gap = unit(1, "mm"))
p3 = ComplexHeatmap::rowAnnotation(HPF_Group=groups_for_pheatmap$Group,col=list(HPF_Group=c("Group 1"="#073444","Group 2"="#bae9fa")),annotation_name_gp = gpar(fontsize = 10, fontface = "bold"), annotation_legend_param = list(title="", labels_gp = gpar(font=2, fontsize = 12)), border = TRUE, show_legend = FALSE, show_annotation_name = FALSE)
